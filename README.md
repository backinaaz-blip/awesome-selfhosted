...
Self-hosting is the practice of hosting and managing applications on your own server(s) instead of consuming from [SaaSS](https://www.gnu.de org/philosophy/who-does-that-server-really-serve.html) providers.
